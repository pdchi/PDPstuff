...
def gaussfit(x, y, double=False, graph=False, quiet=False):
	...
	if double:
		...
		popt_double,pcov_double = curve_fit(double_gaussian_fit, x, y, p0=[intensity1, peak1, FWHM1, peaksep, bkg_counts], sigma=sig_noise, max_nfev=max_fit_repeats,bounds=parambounds)
	...
	## SINGLE GAUSSIAN FITTING ##
		...
		popt_single,pcov_single = curve_fit(single_gaussian_fit, x, y, p0=[intensity1, peak1, FWHM1, bkg_counts], sigma=sig_noise, maxfev=max_fit_repeats)
